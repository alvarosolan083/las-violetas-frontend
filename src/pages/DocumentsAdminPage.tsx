...
import {
    useCreateDocument,
    useDeleteDocument,
} from "../features/documents/documents.mutations";
import type { DocumentItem } from "../features/documents/documents.api";
import {
...
export default function DocumentsAdminPage() {
    ...
    async function handleSubmit(e: React.FormEvent) {
        ...
        try {
            ...
            showToast({
                ...
                message: "El documento fue publicado correctamente.",
            });
        } catch (error) {
            showToast({
                type: "error",
    ...
    async function handleDelete(document: DocumentItem) {
        const ok = window.confirm(
            `¿Eliminar el documento "${document.title}"? Esta acción no se puede deshacer.`,
        );
            ...
            <section className="overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-sm">
                <div className="bg-gradient-to-r from-slate-900 via-slate-800 to-slate-900 px-6 py-7 text-white">
                    ...
                    <p className="mt-2 max-w-2xl text-sm text-slate-200">
                        Publica reglamentos, actas, comunicados y archivos para los
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
                <div className="mb-4">
                    ...
                    <p className="mt-1 text-sm text-slate-600">
                        Completa los datos y adjunta el archivo que quieres publicar.
                    </p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="grid grid-cols-1 gap-4 xl:grid-cols-2">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            className="block h-11 w-full rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm outline-none transition file:mr-3 file:rounded-lg file:border-0 file:bg-slate-100 file:px-3 file:py-1.5 file:text-sm file:font-medium hover:file:bg-slate-200"
                        />
                    </div>
                    ...
                    <div className="xl:col-span-2">
                        ...
                        <textarea
                            ...
                            className="min-h-[110px] w-full rounded-xl border border-slate-200 bg-white p-3 text-sm outline-none transition focus:border-sky-300 focus:ring-4 focus:ring-sky-100"
                        />
                    </div>
                    ...
                    <div className="xl:col-span-2 flex items-center justify-end gap-3">
                        ...
                        >
                            {createMutation.isPending ? "Subiendo..." : "Publicar documento"}
                        </button>
                    </div>
                </form>
            </section>
            ...
            <section className="overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-sm">
                <div className="border-b border-slate-200 px-6 py-4">
                    ...
                    <p className="mt-1 text-xs text-slate-500">
                        Administra los documentos cargados para el condominio.
                    </p>
                </div>
                ...
                {documentsQuery.isLoading ? (
                    ...
                    <div className="px-6 py-12">
                        <EmptyState
                            ...
                            description="Todavía no se ha subido ningún documento."
                        />
                    </div>
                ) : (
                    <div className="divide-y divide-slate-100">
